...
%--------------------------------------------------------------------------
    ...
    % Transform the reference frame of point clouds from camera to base
    ptCloud_tform_cam = pctransform(ptCloud_base,tform_to_cam); 

    % Also do for non-plane specific points
    ...
    %                                                          nonPlane_tform_cam, ...   % nonPlane points wrt to base
    %                                                          myImg, ...                % rgb image
    ...
    for idx = 1: numOfObjects
        ...
        figure(2), pcshow(ptCloud_vec{idx},'ViewPlane','XY');
